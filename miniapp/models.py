...
class miniappUser(models.Model):
    ...
    height = models.CharField(u'身高', max_length=50, default='', null=True, blank=True)
    weight = models.CharField(u'体重', max_length=50, default='', null=True, blank=True)
    birthday = models.DateField(u'生日', null=True, blank=True)
    bloodType = models.CharField(u'血型', max_length=50, default='', null=True, blank=True)
